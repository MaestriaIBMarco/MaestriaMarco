\begin{resumen}%
    \kari{
    A pesar de ser una de las especies más comercializadas en el mercado
    ilegal de mascotas de Argentina, se conoce muy poco sobre la tortuga 
    ...
    una unidad de navegación  autónoma con GPS y un datalogger comercial. 
    ...
    y se 
    encontró que las predicciones no son estadísticamente significativas. 
...
\begin{abstract}%
    ...
    iligal
    pet market, very little is known about the {\it Chelonoidis chilensis} 
    ...
    movement of 27 {\it Chelonoidis chilensis} tortoises were studied using two monitoring 
    techniques: an autonomous GPS navigation unit and a commercial datalogger. A 
